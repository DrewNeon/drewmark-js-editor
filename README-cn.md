...
为[朱码](https://github.com/drewneon/drewmark)量身定制的**所见即所得**编辑器，基于**原生 JavaScript**（Vanilla JS）开发，零依赖。内置[朱码 JS 解析器](https://github.com/drewneon/drewmark-js-parser)，实现实时编辑、预览和下载朱码格式的内容。
