...
*朱码 JS 编辑器*是为朱码量身定制的一款 WYSIWYG 编辑器，基于原生 JavaScript（Vanilla JS）开发，包含 [朱码 JS解析器](/drewneon/drewmark-js-parser)，从而可实时在线编辑、预览、下载*朱码*原文和解析结果。*朱码 JS 编辑器*支持*朱码*的全部语法规则，请查看[朱码](/drewneon/drewmark)了解详细的语法规则。
